        ...
        private boolean attack(LivingEntity target, double squaredDistance) {
            ...
            if (squaredDistance <= d) {
                ...
                if (this.enderwarthogEntity.tryAttack(target)) {
                    ...
                    target.takeKnockback(5.0D, (double) MathHelper.sin(this.enderwarthogEntity.getYaw() * 0.017453292F), (double) (-MathHelper.cos(this.enderwarthogEntity.getYaw() * 0.017453292F)));
                }
                return true;
            } else
                return false;
